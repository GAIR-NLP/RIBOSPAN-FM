...
# Modifications by RIBOSPAN Team:
# 1. Integrated YaRN for length extrapolation.
# 2. Implemented FlashAttention support for efficient long-sequence processing.
#
...
class RNABertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        if not output_attentions:   
            ...
            # use scaled_dot_product_attention (with flash_attention_2)
...
class RNABertAttention(nn.Module):
    def __init__(self, config):
        ...
        self.temperature = 1.0  # Default to 1.0
        ...
        self.self = RNABertSelfAttention(config, temperature=self.temperature)
