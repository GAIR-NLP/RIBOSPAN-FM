...
"""Stage runner: embed -> probe -> summarize."""
...
def run_embed(args: argparse.Namespace) -> None:
    ...
    _call("embed", extract_main, _shared_argv(args) + extra)
...
def run_probe(args: argparse.Namespace) -> None:
    ...
    if args.models:
        extra += ["--models", *args.models]
    _call("probe", probe_main, _shared_argv(args) + extra)
